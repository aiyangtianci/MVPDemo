package com.example.mvpdemo.helper;

import com.example.mvpdemo.utils.AppUtils;
import com.example.mvpdemo.utils.NetworkConnectionUtils;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (NetworkConnectionUtils.isNetworkConnected(AppUtils.getContext())) {
            request = request.newBuilder()
                    ...
                    .header("User-Agent", NetworkConnectionUtils.getUserAgent())
